...
import matplotlib.patches as mpatches# MME565.py
...
class Trapezoid:
    def __init__(self, vertices):
        ...
        self.vertex_list = np.array(vertices)
        ...
        self.center = Point([np.average(self.vertex_list[...,0]), np.average(self.vertex_list[...,1])])
